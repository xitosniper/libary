<%-- 
    Document   : elements
    Created on : Nov 8, 2019, 12:52:13 PM
...
<html lang="en">
    ...
    <head>
        ...
        <title>FatMan | Home - LAWFUL LAWFIRM</title>
        <!-- Bootstrap CSS -->
                            ...
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                ...
                                <li class="nav-item submenu dropdown active">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item active"><a class="nav-link" href="elements.jsp">Elements</a></li>
                                    </ul>
                                </li>
                ...
                <div class="container">
                    <div class="banner_content text-center">
                        <div class="page_link">
                            ...
                            <a href="#">pages</a>
                            <a href="elements.jsp">Element Page</a>
                        </div>
                        <h2>Element Page</h2>
                    </div>
                </div>
