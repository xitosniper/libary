<%-- 
    Document   : charts
    Created on : Nov 8, 2019, 12:50:39 PM
...
<html>
  <head>
    ...
    <title>FatMan | Dashboard - Report</title>
      ...
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            <li class="sidebar-list-item"><a href="dashboard.jsp?username=<%=user_username%>" class="sidebar-link text-muted"><i class="o-home-1 mr-3 text-gray"></i><span>Home</span></a></li>
              <li class="sidebar-list-item"><a href="charts.jsp?username=<%=user_username%>" class="sidebar-link text-muted active"><i class="o-sales-up-1 mr-3 text-gray"></i><span>Report</span></a></li>
          ...
          <section class="py-5">
            <div class="row mb-4">
              <div class="col-lg-8 mb-4 mb-lg-0">
                <div class="card">
                  <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Line chart</h2>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-lg-4">
                ...
                <div class="card mb-3">
                  <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Bar chart</h2>
                  </div>
                  <div class="card-body">
                    <div class="chart-holder">
            ...
            <div class="row mb-4">
              <div class="col-lg-4">
                <div class="card mb-4">
                  <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Pie chart</h2>
                  </div>
                  <div class="card-body">
                    <div class="chart-holder">
              ...
              <div class="col-lg-8">
                <div class="card">
                  <div class="card-header">
                    <h2 class="h6 mb-0 text-uppercase">Bar chart</h2>
                  </div>
                  <div class="card-body">
                    <p class="mb-5 text-gray">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                    <div class="chart-holder mt-5 mb-5">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Doughnut chart</h2>
                  </div>
                  <div class="card-body">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Polar chart</h2>
                  </div>
                  <div class="card-body">
                    <p class="mb-3 text-gray">Lorem ipsum dolor sit amet.</p>
                    <div class="chart-holder">
              ...
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Radar chart</h2>
                  </div>
                  <div class="card-body">
                    <p class="mb-3 text-gray">Lorem ipsum dolor sit amet.</p>
                    <div class="chart-holder">
