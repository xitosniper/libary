<%-- 
    Document   : book-trip
    Created on : Nov 8, 2019, 12:50:16 PM
...
<html lang="en">
    ...
    <head>
        ...
        <title>FatMan | Home - Book Trip</title>
        <!-- Bootstrap CSS -->
                ...
                <div class="container">
                    <div class="banner_content">
                        <div class="page_link">
                            ...
                            <a href="book-trip.jsp">Book a Trip</a>
                        </div>
                        <h2>Book a Trip</h2>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-10">
                        <div class="trip-form-section">
                            ...
                            <form class="trip-form-area trip-page-form trip-form text-right" id="myForm" action="mail.jsp" method="post">
